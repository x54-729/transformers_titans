...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        engram_past_input_ids: Optional[torch.LongTensor] = None,
        **kwargs: Unpack[TransformersKwargs],
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            ...
            ttt_target = self._resolve_ttt_target_states(decoder_layer, inputs_embeds)
            effective_target = engram_target if engram_target is not None else ttt_target
            hidden_states = decoder_layer(
                ...
                cache_position=cache_position,
                position_embeddings=position_embeddings,
                target_states=effective_target,
                **kwargs,
            )
